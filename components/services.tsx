...
const services = [
  
  {
    ...
    features: ["Rutas personalizadas", "Horarios fijos"],
  },
  {
    icon: Users,
    title: "Eventos Empresariales",
    description:
      "Coordinación integral de transporte para congresos, convenciones y eventos corporativos.",
    features: ["Coordinación dedicada", "Logística integral"],
  },
  {
    icon: Calendar,
    title: "Abonos Mensuales",
    description:
      "Planes flexibles para personas con necesidades recurrentes de movilidad.",
    features: [ "Disponibilidad garantizada", "Sin sorpresas"],
  }
...
export function Services() {
  return (
    <section id="servicios" className="bg-background py-[75px]">
